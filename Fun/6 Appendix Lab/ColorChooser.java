...
/**
 * ColorChooser makea working with a color chooser easier
...
public class ColorChooser {
  /**
   * Lets the user pick a color and return the color object.
   * 
  ...
  public static Color pickAColor() {
    ...
    // creates a JFrame to be the parent of the color chooser open dialog
    // if you don't do this then you may not see the dialog
    JFrame frame = new JFrame();
    frame.setAlwaysOnTop(true);
    
    // uses the color chooser to pick the color
    color = JColorChooser.showDialog(frame,"Pick a color",color);
    
    return color;
  }
  
  /** Tests the ColorChooser. */
